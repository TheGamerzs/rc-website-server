...
import { logPayout } from "../../http/log.js";
...
export default class Payout extends Entity {
                ...
                if (req.body.company === "pigs") {
                    ...
                    if (rankVouchers != Infinity) {
                        newProgress = Math.floor(
                            ((memberDetails.pigs.vouchers + voucherAmount) /
                                rankVouchers) *
                                100
                        );
                    } else {
                    ...
                    if (rankVouchers != Infinity) {
                        newProgress = Math.floor(
                            ((memberDetails.rts.vouchers + voucherAmount) /
                                rankVouchers) *
                                100
                        );
                    } else {
    ...
    confirm = async (req, res) => {
        ...
        this.db.sequelize.transaction(async (t) => {
            ...
            member.deadline = this.db.sequelize
                .escape(payout.deadline)
                .slice(1, -1);
