...
import { authenticateRoute } from "./domain/auth/resolvers/authenticateResolver.js";
import { sendStaffNotfication } from "./http/log.js";
import { unauthorizedResponse } from "./http/standardResponses.js";
...
export const routes = (db, app) => {
    ...
    app.get("/api/discord", function (req, res) {
        try {
            authenticateRoute(
                { app: [AppConfigs.permissions.GUEST] },
                req,
