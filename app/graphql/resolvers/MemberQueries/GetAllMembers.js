    ...
    return db.members
        ...
        .then((result) => {
            for (let i = 0; i < result.length; i++) {
                ...
                if (result[i].company == "pigs") {
                    var currentRank = function (MemberDetails) {
                        ...
                        } else if (MemberDetails.pigs.vouchers < 1500000) {
                            //Overlord
                            return "Overlord";
                        } else {
                            return "Swine";
            ...
            return db.managers
                ...
                .then((result) => {
                    for (let i = 0; i < result.length; i++) {
                        response.managers.push({
                            in_game_id: result[i].member.in_game_id,
                        });
                    }
